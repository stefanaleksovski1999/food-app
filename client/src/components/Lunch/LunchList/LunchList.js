    ...
    return ( 
        <div>
            <div className="login-line">
                 <h1 className="title"> <span className="adding-line">{title}</span> </h1>
            </div>
                ...
                {recipes.recipes.map((recipe) => (
                     <div 
                        ...
                        <div className="move-up">
                            ...
                            <h2 className="title-card">{ recipe.title }</h2>
                            <p className="text-card">{ recipe.short_description }</p>
                            ...
                            <div className="card-info">
                                <div className="card-items">
                                    ...
                                    <p className="card-footer-txt">{recipe.preparation_time} min</p>
                                </div>
                                <div className="card-items">
                                    ...
                                    <p className="card-footer-txt">{recipe.no_people} persons</p>
                                </div>
                                <button className="card-items">
                                    ...
                                    <p className="card-footer-txt">{recipe.likes.length}</p>
                                </button>
                                <div className="card-items">
                                    <svg width="16.31px" className="icon-arr" border-radius="5px"  fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M246.6 233.4l-160-160c-12.5-12.5-32.75-12.5-45.25 0s-12.5 32.75 0 45.25L178.8 256l-137.4 137.4c-12.5 12.5-12.5 32.75 0 45.25C47.63 444.9 55.81 448 64 448s16.38-3.125 22.62-9.375l160-160C259.1 266.1 259.1 245.9 246.6 233.4zM438.6 233.4l-160-160c-12.5-12.5-32.75-12.5-45.25 0s-12.5 32.75 0 45.25L370.8 256l-137.4 137.4c-12.5 12.5-12.5 32.75 0 45.25C239.6 444.9 247.8 448 256 448s16.38-3.125 22.62-9.375l160-160C451.1 266.1 451.1 245.9 438.6 233.4z"/></svg>
                                </div>
                            </div>  
                        </div>
                    </div>
